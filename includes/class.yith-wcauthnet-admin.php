	...
	class YITH_WCAUTHNET_Admin {
		...
		public function __construct() {
			$this->admin_tabs = array(
				'credit_card' => __( 'Credit Card Settings', 'yith-woocommerce-authorizenet-payment-gateway' ),
		...
		public function register_panel() {
			$args = array(
				...
				'plugin_slug'      => YITH_WCAUTHNET_SLUG,
				'plugin_description' => __( 'Adds a new gateway to your e-commerce allowing you to accept payments through credit cards and process transactions with Authorize.net reliability.', 'yith-woocommerce-wishlist' ),
		...
		public function action_links( $links ) {
			$links = yith_add_action_links( $links, 'yith_wcauthnet_panel', defined( 'YITH_WCAUTHNET_PREMIUM' ), YITH_WCAUTHNET_SLUG );
		...
		public function enqueue_scripts() {
			...
			if ( ! $screen || 'yith-plugins_page_yith_wcauthnet_panel' !== $screen->id ) {
				return;
			}
			...
			wp_enqueue_script( 'yith_wcauthnet_admin', YITH_WCAUTHNET_URL . 'assets/js/admin/' . $path . 'admin' . $ext . '.js', array( 'jquery' ), YITH_WCAUTHNET_VERSION, true );
		}
